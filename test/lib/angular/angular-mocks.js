 ...
 *
 * <pre>
 *   gistoDev = angular.module('gistoDev', ['gisto', 'ngMockE2E']);
 *   gistoDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('gistolicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('gistolicationModule'));
   *
   *
